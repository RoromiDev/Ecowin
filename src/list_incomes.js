                ...
                {this.state.accounts[parseInt(route.key)].name != 'Tout vos comptes' ?
                    <View style={{ height: '500%', backgroundColor: 'white' }}>
                        ...
                        <View style={{ backgroundColor: 'white', padding: 4 }}>
                            <AccountFullIncomes account={this.state.accounts[parseInt(route.key)]} active={this.state.index} navigation={this.props.navigation} />
                        </View>
                    </View>
                    :
                    <View style={{ height: '500%', backgroundColor: 'white' }}>
                        ...
                        <View style={{ backgroundColor: 'white', padding: 4 }}>
                            <AccountsFullIncomes account={this.state.accounts[parseInt(route.key)]} active={this.state.index} navigation={this.props.navigation} />
                        </View>
                    </View>
                }
            </ScrollView>
        ...
        return (
            <Container style={{ backgroundColor: 'rgb(248, 248, 248)' }}>
                <Header style={{ borderBottomWidth: 0, backgroundColor: 'rgb(44, 44, 44)' }}>
                    ...
                    <Body style={{ flex: 2 }}>
                        <Title style={{ color: 'white', fontFamily: 'Avenir', fontSize: 16 }}>REVENUS</Title>
                    </Body>
