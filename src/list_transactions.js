...
import { AccountFullTransactions } from '../components/account_full_transactions'
import { AccountsBalance } from '../components/accounts_balance'
import { AccountsFullTransactions } from '../components/accounts_full_transactions'
import moment from 'moment';
import 'moment/locale/fr';
import Global from './global'
import { TabViewAnimated, TabViewPagerScroll, TabViewPagerPan, TabBar, SceneMap } from 'react-native-tab-view';

export class ListTransactions extends Component {
    constructor(props) {
        super(props);
        this.state = {
                ...
                {this.state.accounts[parseInt(route.key)].name != 'Tout vos comptes' ?
                    <View style={{ height: '500%', backgroundColor: 'white' }}>
                        ...
                        <View style={{ backgroundColor: 'white', padding: 4 }}>
                            <AccountFullTransactions account={this.state.accounts[parseInt(route.key)]} active={this.state.index} navigation={this.props.navigation} />
                        </View>
                    </View>
                    :
                    <View style={{ height: '500%', backgroundColor: 'white' }}>
                        ...
                        <View style={{ backgroundColor: 'white', padding: 4 }}>
                            <AccountsFullTransactions account={this.state.accounts[parseInt(route.key)]} active={this.state.index} navigation={this.props.navigation} />
                        </View>
                    </View>
                }
            </ScrollView>
        ...
        return (
            <Container style={{ backgroundColor: 'rgb(248, 248, 248)' }}>
                <Header style={{ borderBottomWidth: 0, backgroundColor: 'rgb(44, 44, 44)' }}>
                    ...
                    <Body style={{ flex: 2 }}>
                        <Title style={{ color: 'white', fontFamily: 'Avenir', fontSize: 16 }}>TRANSACTIONS</Title>
                    </Body>
