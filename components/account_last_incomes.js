...
export class AccountLastIncomes extends Component {
        ...
        return (
            <View style={{ marginTop: 0 }}>
                ...
                {this.sortByDate().length != 0 ?
                    <TouchableOpacity onPress={() => { this.props.navigation.navigate('AllIncomesList', { accounts: this.props.account, active: this.props.active }) }}>
                        <CardItem style={{ borderBottomWidth: 1, borderBottomColor: 'rgb(248, 248, 248)' }}>
                            <Text style={{ flex: 3, color: 'rgb(200, 200, 200)', fontFamily: 'Avenir', fontWeight: '300', fontSize: 16 }}>Voir tout les revenus</Text>
                            <Right style={{ flex: 1 }}>
